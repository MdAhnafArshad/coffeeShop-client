...
const UpdateCoffee = () => {
    ...
    const { category, details, photoUrl, quantity,  _id } = newCoffee
    ...
    const handleUpdate = event => {
        ...
        fetch(`http://localhost:5000/addCoffee/${_id}`, {
            ...
            .then(data => {
                ...
                Swal.fire({
                    title: 'Sweet!',
                    text: 'ooooo add your item update.',
    ...
    return (
        <div>
            <h2 className="text-5xl font-bold text-pink-800">Update your coFFee</h2>
            <form onSubmit={handleUpdate}>
                ...
                <div className="form-control grid lg:grid-cols-2 md:grid-cols-1 gap-2">
                    <div>
                        ...
                        <label className="input-group ">
                            <input type="text" name="Name" placeholder="Name" className="input input-bordered w-full" defaultValue={category} />
                        </label>
                    </div>
                    <div>
                ...
                <div className="form-control ">
                    <div>
                        ...
                        <label className="input-group ">
                            <input type="text" name="photoUrl" placeholder="photo url" className="input input-bordered w-full" defaultValue={photoUrl} />
                        </label>
                    </div>
